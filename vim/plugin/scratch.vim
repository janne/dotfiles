...
" § should create a new scratch buffer. You can do your scribes
" here and if you want to get rid of it, hit § again inside scratch buffer
" window. If you want to get back to the scratch buffer repeat §. Use
...
"----------------------------------------------------------------------
"Standard Inteface:  § to make a new ScratchBuffer, §-again to hide one
...
if (! exists("no_plugin_maps") || ! no_plugin_maps) &&
  ...
  if !hasmapto('<Plug>ShowScratchBuffer',"n")
    nmap <unique> <silent> § <Plug>ShowScratchBuffer
  endif
  if !hasmapto('<Plug>InsShowScratchBuffer',"i")
    imap <unique> <silent> § <Plug>InsShowScratchBuffer
  endif
endif
